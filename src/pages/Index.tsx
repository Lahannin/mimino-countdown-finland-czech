    ...
    <div className="min-h-screen">
      <div className="max-w-2xl mx-auto px-5 py-10 md:py-20 space-y-5">
        ...
        >
          ...
          <p className="mt-2 text-lg md:text-2xl font-display font-semibold bg-clip-text text-transparent" style={{ backgroundImage: 'linear-gradient(90deg, hsl(340 80% 55%), hsl(320 70% 60%), hsl(280 60% 65%))' }}>
