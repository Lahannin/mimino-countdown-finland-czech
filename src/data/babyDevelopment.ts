...
const dailyDevelopments: DailyBabyInfo[] = [
  ...
  { dayTitle: "Almost there!", sizeEmoji: "🎉", funFact: "She's nearly full-term, getting ready to meet isi and maminka!", tip: "Make sure the hospital bag is packed, holčička can come any time!" },
